...
<Columns cols={2}>
  <Card title="Break a protected action in your browser" icon="play" href="/try">
    No install. Approve €2,000, execute €5,000, lose a reply, retry: see each decision in this tab.
  </Card>
...
agent trying to act outside what was delegated to it. [Try the scenarios](/try) walks
the same decisions without an install and lets you break one refund yourself, or read the full transcript in the
[repository README](https://github.com/CTRLRun/ctrlrun#what-ctrlrun-demo-shows).

## What it does

{/* generated from capabilities.yaml (mdx) — edit the YAML, never this grid */}
<Columns cols={2}>
...
<Columns cols={3}>
  ...
  <Card title="Try the scenarios" icon="flask" href="/try">
    One refund you can break six ways, and the five demo scenarios, as an illustration.
  </Card>

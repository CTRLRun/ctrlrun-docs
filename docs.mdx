...
<Columns cols={2}>
  <Card title="See what stops an agent action" icon="play" href="/execution-boundary">
    No install. The path an action takes, the five checks on it, and the refusal each one raises.
  </Card>

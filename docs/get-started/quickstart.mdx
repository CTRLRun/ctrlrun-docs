...
would rather see it before you type it, [the execution boundary](/execution-boundary) draws the
same decisions with no install.

<div className="cr-film-block">
  ...
  <p className="cr-caption">Forty-nine seconds: the policy file below, and the refusals it produces. Plays muted with captions.</p>
</div>

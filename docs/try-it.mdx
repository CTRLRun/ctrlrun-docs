...
[`verify-browser-demo.mjs`](https://github.com/CTRLRun/ctrlrun-docs/blob/main/assets/verify-browser-demo.mjs)
...
[`verify-browser-wiring.mjs`](https://github.com/CTRLRun/ctrlrun-docs/blob/main/assets/verify-browser-wiring.mjs)

...
<Steps>
  ...
  <Step title="Point Shields at it">
    ```markdown
    [![CTRLRun verified](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/OWNER/REPO/badges/verify-badge.json)](https://github.com/CTRLRun/ctrlrun-docs/blob/main/docs/verify.md#what-the-badge-means)
    ```

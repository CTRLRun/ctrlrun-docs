...
- [`docs/THREAT_MODEL.md`](/docs/THREAT_MODEL): what the guarantees do not cover.
- [`docs/verify.md`](/docs/verify): running the guarantees against your own configuration.

...
title: "CTRLRun"
sidebarTitle: "Home"
description: "The execution safety layer for AI agents. A consequential action happens at most once, exactly as approved, and leaves a receipt."
mode: "wide"
...
Autonomy belongs to the action, not the agent. A consequential action happens at most once,
exactly as approved, and leaves a receipt — and when the outcome is unknown, CTRLRun says so
instead of guessing.
...
<Columns cols={2}>
  <Card title="Break a protected action in your browser" icon="play" href="/try-it">
    No install. Real Python and the released wheel run in this tab.
  </Card>
  <Card title="Protect your first action" icon="shield" href="/get-started/quickstart">
...
[cookbook](/cookbook/index) has each of those as a runnable recipe.
...
<Columns cols={3}>
  <Card title="Protect your first action" icon="play" href="/get-started/quickstart">
    Protect one function end to end and read the receipt. Ten minutes.
  </Card>
  <Card title="Try it in your browser" icon="flask" href="/try-it">
    The five demo scenarios, running on the released wheel in this tab.
  </Card>

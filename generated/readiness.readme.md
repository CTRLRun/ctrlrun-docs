...
- **Version 0.9.0**, on [PyPI](https://pypi.org/project/ctrlrun/), Python 3.11 and later, tested on 3.11 to 3.14.
- **5,974 tests**, every version specified before it was written and every requirement mutation-tested.

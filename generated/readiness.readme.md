...
- **Version 0.10.0**, on [PyPI](https://pypi.org/project/ctrlrun/), Python 3.11 and later.
- **6,048 tests**, every version specified before it was written and every requirement mutation-tested.
